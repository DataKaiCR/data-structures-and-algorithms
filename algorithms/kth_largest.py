...
class KthLargest:
    ...
    def __init__(self, arr: list, k: int) -> None:
        # We want our object instantiation to fail if the following contraints are not met. Doing so prevents any further computation which would be a waste of resources.
        # Method 1
    ...
    def compute_kth_with_heap(self) -> int:
        if not self.base_case():
